      ...
      <div className="bg-white p-6 rounded-lg w-96">
        ...
        {editedItem && (
          <div>
            ...
            <label className="block mb-2">
              Country:
              <input type="text" name="country" value={editedItem.businessUnit.contactInformations[0].country || ''} onChange={handleChange} className="border-gray-400 border rounded-md px-4 py-2 mt-1 block w-full" />
            </label>
            <label className="block mb-2">
              Currency:
