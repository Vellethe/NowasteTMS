...
import getAllTransportOrders from '../APICalls/TransportOrders/GetAllHistoricalTransportOrders';
import getAllServices from '../APICalls/Service/GetAllServices';

const HistoricalTransportOrderTable = () => {
...
export default HistoricalTransportOrderTable;