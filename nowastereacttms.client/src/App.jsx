    ...
    <Router>
      <Routes>
        <Route path="/" element={<MasterLayout/>}>
          <Route path="/" element={<AllOrders />} />         {/* /Transport/Order/AllOrders */}

          <Route path="/Transport/Order/AllHistoricalOrders" element={<AllHistoricalOrders />}
          />
        ...
        <Route path="/Transport/Customers/AllCustomers" element={<Customers/>}/>
        <Route path="/Transport/Suppliers/AllSuppliers" element={<Suppliers/>}/>
        <Route path="/Transport/TransportOrderService" element={<TransportOrderService/>}/> */}
        </Route>
