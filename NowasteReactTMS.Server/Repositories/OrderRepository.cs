...
//            // Searching for zero, in this case, also means searching for null.
...
//        //{
//        //    var body = JsonConvert.SerializeObject(order, Formatting.None, new JsonSerializerSettings());
//        //    var queryString = new StringContent(body, Encoding.UTF8, "application/json");
//        //    var response = await client.PostAsync(_config.BaseUrl + UrlSpecificOrder, queryString);
...
//            // Note: /* view */ just means value is used in the view, one of the table-rows.
//            var sqlTemplate = @"
//                SELECT 
//                       po.[OrderPK] AS Id
//                      ,po.[OrderPK]     /* view */
